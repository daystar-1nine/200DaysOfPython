...
# Objective  : Test /users/me, /users/me/orders, and /admin/users (403 for user, 200 for admin).
...
def test_admin_list_users_as_normal_user_returns_403(client, normal_user_headers):
    """Test regular user attempting to call /admin/users gets HTTP 403 Forbidden with standardized error."""
