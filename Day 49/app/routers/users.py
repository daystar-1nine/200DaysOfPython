...
@router.get(
    ...
    description="Retrieves profile metadata for the currently authenticated user (excluding password_hash)."
)
...
@router.get(
    ...
    description="Retrieves list of purchase orders belonging to the currently authenticated user."
)
...
@router.get(
    ...
    description="Admin-only endpoint listing all registered user accounts in the application."
)
