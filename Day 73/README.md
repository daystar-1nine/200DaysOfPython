...
- **Slope ($b_1$):** $0.4485$ (Every additional \$1,000 spent on advertising is associated with approximately \$448.50 in incremental sales revenue).
- **Intercept ($b_0$):** \$12,410.82 (Baseline sales revenue expected in the theoretical absence of advertising expenditure).
- **Residual Mean ($\bar{e}$):** $-0.0000$ (Confirms unbiased estimator property).
