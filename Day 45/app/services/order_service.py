...
# Concept    : Database Transactions (BEGIN, COMMIT, ROLLBACK) & Business Validation (Day 45 requirement)
...
class OrderService:
    """Service orchestrating transactional order placement and inventory updates."""
    ...
    # What is used : Atomic Transactional Order Placement (create_order)
    # Why it is used: Enforces atomic commit/rollback behavior across multiple database tables
    def create_order(self, payload: OrderCreate) -> Order:
        ...
        try:
            # Step 2 & 3: Verify products exist and check stock availability
            ...
            # Step 4 & 5: Create Order entity (Pending commit)
            ...
            # Step 6 & 7: Create OrderItems and reduce product stock
            for product, qty, price in items_to_process:
                ...
                product.stock -= qty  # Inventory reduction
            ...
            # Rollback database transaction on error to prevent partial stock updates
            self.db.rollback()
            raise e
