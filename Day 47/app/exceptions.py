...
# Objective  : Custom domain exception hierarchy mapped to HTTP 400, 401, 403, and 404 status codes.
# Concept    : Security & Exception Domain Mapping
# Why Used   : Provides HTTP 401 (Unauthorized) and HTTP 403 (Forbidden) exceptions.
# ==============================================================================
