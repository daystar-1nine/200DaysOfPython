...
# Objective  : APIRouter for /users CRUD and /users/{id}/with-orders endpoints.
# Concept    : Modular Resource Router
# Why Used   : Exposes user endpoints with phone numbers and creation timestamps.
# ==============================================================================
