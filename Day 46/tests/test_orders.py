...
# Concept    : Database Transaction & Atomic Inventory Testing
# Why Used   : Asserts atomic commit/rollback guarantees during order checkout.
# ==============================================================================

def test_create_order_success(client):
    res_u = client.post("/users", json={"name": "Suraj", "email": "suraj@example.com", "phone": "9876543210"})
...
def test_create_order_transaction_rollback_on_stock_error(client):
    ...
    # Verify product 1 stock was NOT decremented due to rollback
